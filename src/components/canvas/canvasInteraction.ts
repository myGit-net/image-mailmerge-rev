import { parseMarkdownText, applyTextFormatting, getTextBounds } from '../text/textFormatting';
    ...
    if (hit.index >= 0) {
      ...
      if (hit.isResizeHandle) {
        ...
        dragStartRef.current = { 
          ...
          fieldX: field.x, 
          fieldY: field.y, 
          fontSize: field.type === 'text' ? field.fontSize : (field.type === 'qrcode' ? field.size : 0)
        };
